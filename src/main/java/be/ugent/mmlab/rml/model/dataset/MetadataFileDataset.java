 ...
 * @author andimou
 */
public class MetadataFileDataset extends StdMetadataRMLDataset {

    // Log
    private static final Logger log = 
            LoggerFactory.getLogger(MetadataFileDataset.class);
    
    private File target;
        
    public MetadataFileDataset(String target) {
        try {
     ...
     * @param repositoryID
     */
    public MetadataFileDataset(String target, String outputFormat, 
